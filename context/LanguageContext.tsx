...
const translations = {
  en: {
    ...
    proj_sap_desc: 'Implementation of high-performance bridge between custom web interfaces and SAP S/4HANA systems. Developed OData V4 services and ABAP RESTful Application Programming model (RAP) to enable seamless data exchange and real-time process monitoring.',
  ...
  fr: {
    ...
    proj_sap_desc: 'Mise en œuvre d\'un pont haute performance entre des interfaces web personnalisées et les systèmes SAP S/4HANA. Développement de services OData V4 et du modèle ABAP RESTful Application Programming (RAP) pour permettre un échange de données fluide et une surveillance des processus en temps réel.',
