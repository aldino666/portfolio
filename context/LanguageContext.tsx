...
const translations = {
  en: {
    ...
    journey_sap_work_title: 'SAP Training & Work (SAPERP solution)',
    journey_sap_work_desc: 'Focused on SAP ERP development and functional expertise within a professional environment.',
  ...
  fr: {
    ...
    journey_sap_work_title: 'Formation & Travail SAP (SAPERP solution)',
    journey_sap_work_desc: 'Spécialisation dans le développement ERP SAP et expertise fonctionnelle en milieu professionnel.',
